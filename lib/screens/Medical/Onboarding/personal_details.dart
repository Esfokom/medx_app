...
import 'package:medx/screens/Medical/Onboarding/doctor_details.dart';
...
class _PersonalDetailsState extends State<PersonalDetails> {
  ...
  void setBasicDetails() async {
    ...
    doctor.gender = gender! ? "Male" : "Female";
    doctor.country = country.text;
    doctor.profilePic = profilePic;
    doctor.email = await FirebaseAuth.instance.currentUser?.email;
